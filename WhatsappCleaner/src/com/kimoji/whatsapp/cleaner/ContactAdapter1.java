...
public class ContactAdapter1 extends BaseAdapter{
	...
	Context context;
	WhatsAppImagesActivity activity;
	String fragmentName;
	ImageLoader mImageLoader;

	public ContactAdapter1(Activity activity,ArrayList<WhatsppImages> myList2,ImageLoader mImageLoader2, String string) {

		this.mImageLoader=mImageLoader2;
		this.myList = myList2; 
		this.activity=(WhatsAppImagesActivity) activity;

...
public class ImagesAdapter extends MultiSelect<ImagesAdapter.ViewHolder> {
    public static final String A4 = "8fc19dv";
    public Context mContext;
    private ArrayList<ImagesAlbum> mAlbumImages;
    private ViewHolder.ClickListener clickListener;
    public ImagesAdapter(Context context, ArrayList<ImagesAlbum> arrayList, ViewHolder.ClickListener context2) {

...
import com.cleaner.whatapp.GalleryDpActivity;
import com.cleaner.whatapp.R;
import com.cleaner.whatapp.ShowDp;
...
public class DpDownload extends Fragment implements
        DpsAdapter.ViewHolder.ClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        album = inflater.inflate(R.layout.dp_download, container, false);
        return album;
    }
    private void main() {
        ...
        getallimages();
        mAdapter_image = new DpsAdapter(getActivity(), getAlbumImages(), this);
    ...
    private ArrayList<DpAlbum> getAlbumImages() {
        ArrayList<DpAlbum> paths = new ArrayList<DpAlbum>();
        for (int i = 0; i < FileNameStrings.size(); i++) {
            DpAlbum albumImages = new DpAlbum();
    ...
    public void onItemClicked(int position) {
        ...
        if (longclick) {
            ...
            Intent i = new Intent(getActivity(), ShowDp.class);

...
public class DpAdapter extends PagerAdapter {
    Activity mContext;
    LayoutInflater mLayoutInflater;
    File[] mFiles;
    public DpAdapter(Activity context, File[] files) {
        mContext = context;
        this.mFiles = files;
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        View itemView = mLayoutInflater.inflate(R.layout.dp_viewpager_item_image, container, false);

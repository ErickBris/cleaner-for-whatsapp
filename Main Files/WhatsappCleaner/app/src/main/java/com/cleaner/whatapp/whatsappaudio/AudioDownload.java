package com.cleaner.whatapp.whatsappaudio;
...
import com.cleaner.whatapp.GalleryAudioActivity;
import com.cleaner.whatapp.R;
import com.cleaner.whatapp.ShowAudio;
...
public class AudioDownload extends Fragment implements
        AudioAdapter.ViewHolder.ClickListener {
    String myAppName, path, org_path;
    View videos;
    RecyclerView mRecyclerView_allvideo;
    AudioAdapter mAdapter_video;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        videos = inflater.inflate(R.layout.audio_download, container, false);
        return videos;
    }
    private void main() {
        ...
        getallvideos();
        mAdapter_video = new AudioAdapter(getActivity(), getAlbumvideos(), this);
    ...
    private void getallvideos() {
        ...
        if (!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            ...
            file = new File(Environment.getExternalStorageDirectory(), StaticVariables.rootDir + "/" + StaticVariables.audDir + "/");
            file.mkdirs();
        }
        if (file.isDirectory()) {
            ...
            for (int i = 0; i < listFile.length; i++) {
                if (!listFile[i].getName().contains(".m4a")) {
    ...
    public void onItemClicked(int position) {
        ...
        if (longclick) {
            ...
            Intent i = new Intent(getActivity(), ShowAudio.class);
    ...
    public void refresh() {
        ...
        mAdapter_video = new AudioAdapter(getActivity(), getAlbumvideos(), this);
        mRecyclerView_allvideo.setAdapter(mAdapter_video);
        GalleryAudioActivity.delete.setVisible(false);
        GalleryAudioActivity.share.setVisible(false);
        mShareVideos.clear();
        longclick = false;
    }
    private void setimage(String imagepath2, int i) {
        ...
        if (video_count == 0) {
            ...
            GalleryAudioActivity.delete.setVisible(true);
            GalleryAudioActivity.share.setVisible(true);
        }
    }
    @Override
